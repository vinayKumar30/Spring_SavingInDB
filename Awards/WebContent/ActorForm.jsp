...
<body
	...
	<form action="actor.do">
		<div class="container w-50%">
			<div class="card-body" align="center">
				<h2 class="card-title" font="bold" style="font-family: italica;">
					<b>Choose your favourite Lead cast</b>
				</h2>

				<div class="form-group">
					<div class="form-group col-md-3">
						<label for="LeadActorName"></label> <input type="text"
							class="form-control" placeholder="Enter Lead ActorName"
							id="LeadActorName" name="leadActorName">
					</div>

					<div class="form-group">
						<div class="form-group col-md-3">
							<label for="LeadSupportingActorName"></label> <input type="text"
								class="form-control" placeholder="Lead Supporting ActorName"
								id="LeadSupportingActorName" name="leadSupportingActorName">
						</div>
