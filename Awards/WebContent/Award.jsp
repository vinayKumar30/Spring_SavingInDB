					...
					<div class="card-body" align="center">
						...
						<div class="form-group">
							<div class="form-group col-md-3">
								<label for="AwardName"></label> <input type="text"
									class="form-control" placeholder="Enter Award Name"
									id="awardName" name="awardName">
							</div>

							<div class="form-group">
								<div class="form-group col-md-3">
									<label for="Sponser"></label> <input type="text"
										class="form-control" placeholder="Enter Sponser name"
										id="Sponser" name="sponser">
								</div>

								<div class="form-group">
									<div class="form-group col-md-3">
										<label for="Gift"></label> <input type="text"
											class="form-control" placeholder="Enter Gift" id="Gift"
											name="gift">
									</div>
